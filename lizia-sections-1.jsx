    ...
    <section id="problema" className="section">
      <div className="container reveal" ref={ref}>
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          ...
          <h2 style={{ fontSize: 'clamp(2.8rem, 5vw, 3.5rem)', fontWeight: 800, letterSpacing: '-0.03em', lineHeight: 1.1, maxWidth: 700, margin: '0 auto', width: '100%' }}>
    ...
    <section id="diagnostico" className="section">
      <div className="container reveal" ref={ref}>
        <div style={{
          ...
          {!showResult ?
          <>
              <h2 style={{ fontSize: 'clamp(2.8rem, 5vw, 3.5rem)', fontWeight: 800, marginBottom: 8, lineHeight: 1.1, textWrap: 'pretty', textAlign: "center", letterSpacing: '-0.03em' }}><span className="grad-text section-title">Evaluá cuánto podrías ganar con Lizia</span></h2>
