...
function LogoCloud() {
  /* SVG logos inline for each brand */
  const logoData = [
  ...
  onMouseEnter={(e) => {e.currentTarget.style.background = 'rgba(255,255,255,0.14)';e.currentTarget.style.borderColor = 'rgba(34,211,238,0.3)';}}
  onMouseLeave={(e) => {e.currentTarget.style.background = 'rgba(255,255,255,0.08)';e.currentTarget.style.borderColor = 'rgba(255,255,255,0.12)';}}>
      ...
      <span style={{ fontFamily: "'Inter Tight', sans-serif", fontWeight: 600, fontSize: 14, color: '#fff', letterSpacing: '0.01em' }}>{item.name}</span>
    </div>;
